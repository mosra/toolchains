...
if(EMSCRIPTEN_TARGET_THREADS)
    list(APPEND CMAKE_CXX_FLAGS_INIT "-pthread")
    list(APPEND CMAKE_EXE_LINKER_FLAGS_INIT "-pthread")
endif()

if(EMSCRIPTEN_TARGET_SIMD)
    list(APPEND CMAKE_CXX_FLAGS_INIT "-msimd128")
endif()
